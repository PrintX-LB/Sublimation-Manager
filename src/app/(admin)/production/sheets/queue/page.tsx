...
export default async function SheetQueuePage({
  searchParams,
}: {
  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-5">
      <WorkflowHeader
        title="Automatic Sheet Pairing"
        description="Review compatible Ready to Print transfers before generating physical A4 sheets."
        backLabel="Back to Generated Sheets"
      ...
      <div className="flex flex-wrap gap-2">
        <Link
          href="/production/sheet-builder"
          className="text-brand-200 rounded border border-slate-700 px-3 py-2 text-xs"
        >
          Open Manual Builder
        </Link>
        <Link
        ...
        <Link
          href="/production/sheets/queue"
          className="rounded border border-slate-700 px-3 py-2 text-xs text-slate-300"
        >
          Refresh queue
        </Link>
        <Link href="/production/sheets/queue?reset=1" className="rounded border border-slate-700 px-3 py-2 text-xs text-slate-300">Reset Suggestions</Link>
      </div>
