    ...
    <div className="w-full space-y-5">
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_340px]">
        <section className="space-y-5">
          <div className="rounded-xl border border-slate-700 bg-slate-900/70 p-4 h-full">
            <div className="flex h-[calc(100vh-180px)] items-center justify-center rounded-lg bg-slate-950 p-4">
              {available && isPdf ? (
                <iframe src={fileUrl} title={`${sheet.filename} PDF preview`} className="h-full w-full rounded border-0" />
              ) : (
                <img
